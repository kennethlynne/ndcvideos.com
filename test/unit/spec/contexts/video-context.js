describe('Model Context: VideoContext', function () {

    var VideoContext, $httpBackend, VideoModel, $rootScope;

    beforeEach(function () {

        module('ndc');

        inject(function (_VideoContext_, _$httpBackend_, _VideoModel_, _$rootScope_) {
            VideoContext = _VideoContext_;
    ...
    describe('getById', function () {
        it('should return models by id', function() {
            ...
            var promise = VideoContext.getById(5);
    ...
    describe('getAll', function () {
        it('should return models by id', function() {
            ...
            var promise = VideoContext.getAll();
        ...
        it('should handle rejects', function() {
            ...
            var promise = VideoContext.getAll(5),
                success = jasmine.createSpy('success'),
                error = jasmine.createSpy('error');
    ...
    describe('attach', function () {
        ...
        it('should throw if trying to attach a model that is not of valid type', function() {
            function wrapper() {
                VideoContext.attach({fails: true});
            }
        ...
        it('should return the attached model on subsequent requests', function() {
            ...
            VideoContext.attach(new VideoModel({id: 5, title:'Video title'}));

            var Video;

            VideoContext.getById(5).then(function (response) {
                Video = response;
            });
    ...
    describe('create', function () {
        it('should return a newed up instance of the Video Model', function() {
            var Video = VideoContext.create({title:'New title'});
            expect(Video instanceof VideoModel).toBe(true);
    ...
    describe('_pool', function () {
        it('should return a reference to the pool', function() {
            ...
            VideoContext._pool[19] = newVideo;

            var Video;
            VideoContext.getById(19).then(function (response) {
                Video = response;
            });
            $rootScope.$digest();
